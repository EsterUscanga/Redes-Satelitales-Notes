...
Un satélite es un objeto en el espacio que orbita o da vueltas alrededor de un objeto más grande. Se divide en dos tipos: Naturales y artificiales.
...
### 7. Cual es el periodo orbital de un objeto en una orbita estacionaria?
 ...
 El periodo orbital es igual al periodo de rotación sidéreo de la Tierra, 23 horas, 56 minutos y 4,09 segundos. Debido a que su latitud siempre es igual a 0º, las localizaciones de los satélites sólo varían en su longitud. 
...
- Basura espacial
    - Se calcula que en total puede haber más de 500.000 pequeños objetos (considerados como basura) del tamaño de un boliche o más grande, que orbita alrededor de la Tierra. De ellos 20.000 son más grandes que una pelota de béisbol. Y recordamos que solamente hasta un pequeño trozo de pintura para dañar un satélite

### 16. Menciona el tipo de seguro y cobertura para un satelite            

Los dos momentos críticos que delimitan las coberturas en los satélites, que son el lanzamiento y la vida en órbita. En la fase de lanzamiento, explica, se cubre el momento de mayor riesgo en la operación del satélite, que puede llegar a ser hasta de 40 minutos. Durante la fase de vida en órbita, cuya cobertura tiene una duración de 12 meses, se renueva anualmente el seguro hasta completar la vida útil del satélite, que suele ser de 15 años. Destacan las especialistas que la mejora de la tecnología ha provocado que disminuyan los fallos en los satélites y los incidentes y se reduzcan los costes de aseguramiento. Así, a finales de los 90, el coste de los seguros en el momento del lanzamiento oscilaba entre el 20% y el 25% mientras que actualmente ésta horquilla se ha reducido al 5% y 7%”.
